...
class TestIntentsResult(unittest.TestCase):
    ...
    def test_dict(self):
        result = Result({"a": 1}, local=False, target_device_id="id")
        self.assertEqual(
    ...
    def test_bool_result_with_secondary_device(self):
        """TargetDeviceId is nullified if data is empty"""
        result = Result({})
